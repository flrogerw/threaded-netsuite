...
final class Netsuite_Db_Query
{
	...
	protected static $RESET_STALLED_ORDERS = "UPDATE fotobar_order_queue SET times_run = (@cur_value := times_run) + 1, order_status = 'pending' WHERE ( order_status = 'working' OR order_status = 'error' ) AND times_run < 2";

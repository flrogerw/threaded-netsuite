...
final class Panel_Query
{
	...
	protected static $GET_POS_TEST_RESULTS = "SELECT livepos_test_orders.*, process_log.order_id FROM livepos_test_orders JOIN process_log ON livepos_test_orders.receipt_id = process_log.order_activa_id";
